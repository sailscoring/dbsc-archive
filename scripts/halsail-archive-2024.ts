/**
 * Build the 2024 DBSC season from the archive as Sail Scoring `.sailscoring`
 * files — one per finish-sheet day-group. Machinery lives in
 * lib/halsail/archive-build.ts; this file is just the 2024 day-group configs.
 *
 *   pnpm archive:2024            # build every group
 *   pnpm archive:2024 thursday-cruisers   # one group
 *   pnpm archive:2024 --no-validate
 */
...
const { frag, tandemFrags, runMain } = archiveBuilder('2024');

const THURSDAY_CRUISERS: Group = {
  out: 'dbsc-2024-thursday-cruisers', name: 'DBSC 2024 — Thursday Cruisers',
  day: 'Thursday', echoSuffix: 'Thu',
  subSeriesNames: ['Thursday Overall', '2024 Thursday Series A', '2024 Thursday Series B'],
  classNames: [
    ...
    'Cruisers 1 - J109', 'Cruisers 2 - Sigma33', 'Cruisers 4A-5A NS VPRS', 'Cruisers 4B-5B NS VPRS',
    'Cruisers 5A Echo (Thu)', 'Cruisers 5B Echo (Thu)',
  ],
  fleetClassOverride: {
    'J/109': 'Cruisers 1 - J109', 'Sigma 33': 'Cruisers 2 - Sigma33',
    'Cruisers 4-5A VPRS': 'Cruisers 4A-5A NS VPRS', 'Cruisers 4-5B VPRS': 'Cruisers 4B-5B NS VPRS',
  ...
  build: (opts) => buildCruiserDaySeries(
    [
      ...
      { classNum: 3, echo: frag('Cruisers 3 Echo (Thu)', 'Thursday Overall'), irc: frag('Cruisers 3 IRC', 'Thursday Overall'), echoTandems: tandemFrags('Cruisers 3 Echo (Thu)', '2024 Thursday') },
    ],
    [
    ...
    opts,
    [
      { vprsFleetId: 'cf-45a-vprs', vprsName: 'Cruisers 4-5A VPRS', startKey: '45a', vprs: frag('Cruisers 4A-5A NS VPRS', 'Thursday Overall'), echoFleets: [{ fleetId: 'cf-5a-echo', name: 'Cruisers 5A ECHO', echo: frag('Cruisers 5A Echo (Thu)', 'Thursday Overall') }] },
      { vprsFleetId: 'cf-45b-vprs', vprsName: 'Cruisers 4-5B VPRS', startKey: '45b', vprs: frag('Cruisers 4B-5B NS VPRS', 'Thursday Overall'), echoFleets: [{ fleetId: 'cf-5b-echo', name: 'Cruisers 5B ECHO', echo: frag('Cruisers 5B Echo (Thu)', 'Thursday Overall') }] },
    ],
  ),
};
...
const THURSDAY_OD: Group = {
  out: 'dbsc-2024-thursday-od', name: 'DBSC 2024 — Thursday One-designs & Sportsboats',
  day: 'Thursday', echoSuffix: 'Thu',
  subSeriesNames: ['Thursday Overall', '2024 Thursday Series A', '2024 Thursday Series B'],
  classNames: [
...
const SATURDAY_CRUISERS: Group = {
  out: 'dbsc-2024-saturday-cruisers', name: 'DBSC 2024 — Saturday Cruisers',
  day: 'Saturday', echoSuffix: 'Sat',
  subSeriesNames: ['Saturday Overall', '2024 Saturday Series A', '2024 Saturday Series B'],
  classNames: [
  ...
  build: (opts) => buildCruiserDaySeries(
    ...
    opts,
    [
      { vprsFleetId: 'cf-45a-vprs', vprsName: 'Cruisers 4-5A VPRS', startKey: '45a', vprs: frag('Cruisers 4A-5A NS VPRS', 'Saturday Overall'), echoFleets: [{ fleetId: 'cf-5a-echo', name: 'Cruisers 5A ECHO', echo: frag('Cruisers 5A Echo (Sat)', 'Saturday Overall') }] },
      { vprsFleetId: 'cf-45b-vprs', vprsName: 'Cruisers 4-5B VPRS', startKey: '45b', vprs: frag('Cruisers 4B-5B NS VPRS', 'Saturday Overall'), echoFleets: [{ fleetId: 'cf-5b-echo', name: 'Cruisers 5B ECHO', echo: frag('Cruisers 5B Echo (Sat)', 'Saturday Overall') }] },
    ],
  ),
};

// Saturday "One-designs, Sportsboats & PY" sheet — the biggest day. Mirrors the
// 2026 saturday-od, minus J/80.
const SATURDAY_OD: Group = {
  out: 'dbsc-2024-saturday-od', name: 'DBSC 2024 — Saturday One-designs, Sportsboats & PY',
  day: 'Saturday', echoSuffix: 'Sat',
  subSeriesNames: ['Saturday Overall', '2024 Saturday Series A', '2024 Saturday Series B'],
  classNames: [
    'Dragon', 'Flying Fifteen', 'Ruffian 23', 'SB20', 'Shipman', 'Sportsboats',
  ...
  build: (opts) => buildFleetSeries(
    [
      { fleetId: 'fl-dragon', name: 'Dragon', system: 'scratch', fragment: frag('Dragon', 'Saturday Overall'), tandemFragments: tandemFrags('Dragon', '2024 Saturday') },
      ...
      { fleetId: 'fl-sb20', name: 'SB20', system: 'scratch', fragment: frag('SB20', 'Saturday Overall'), tandemFragments: tandemFrags('SB20', '2024 Saturday') },
      { fleetId: 'fl-shipman', name: 'Shipman', system: 'scratch', fragment: frag('Shipman', 'Saturday Overall') },
      { fleetId: 'fl-sportsboats', name: 'Mixed Sportsboats', system: 'vprs', fragment: frag('Sportsboats', 'Saturday Overall'), tandemFragments: tandemFrags('Sportsboats', '2024 Saturday') },
...
// Water Wags (Wednesday): one scratch one-design fleet. In 2024 the Overall tandem
// is "2024 Summer Series" and the race-subset tandems are "2024 Weds Series A/B/C".
const WATER_WAGS: Group = {
  out: 'dbsc-2024-water-wags', name: 'DBSC 2024 — Water Wags',
  day: '2024', echoSuffix: '',
  subSeriesNames: ['2024 Summer Series', '2024 Weds Series A', '2024 Weds Series B', '2024 Weds Series C'],
    ...
    [
      {
        ...
        fragment: frag('Water Wag', '2024 Summer Series'),
        tandemFragments: tandemFrags('Water Wag', '2024 Weds', ['Series A', 'Series B', 'Series C']),
      },
    ] satisfies DayFleetSpec[],
    opts,
  ),
...
// time-on-time handicap and publishes under "2024 Summer Series" — hence the
// explicit subSeriesNames (each auto-scopes to the fleets that publish it).
const TUESDAY_OD: Group = {
  out: 'dbsc-2024-tuesday-od', name: 'DBSC 2024 — Tuesday One-designs, Sportsboats & PY',
  day: 'Tuesday', echoSuffix: 'Tue',
  subSeriesNames: ['Tuesday Overall', '2024 Tuesday Series A', '2024 Tuesday Series B', '2024 Tuesday Series C'],
  classNames: [],
  fleetClassOverride: {
    'Mixed Sportsboats': 'Sportsboats',
  ...
  build: (opts) => buildFleetSeries(
    [
      { fleetId: 'fl-fireball', name: 'Fireball', system: 'scratch', fragment: frag('Fireball', 'Tuesday Overall'), tandemFragments: tandemFrags('Fireball', '2024 Tuesday', ['Series A', 'Series B', 'Series C']) },
      { fleetId: 'fl-idra14', name: 'IDRA 14', system: 'scratch', fragment: frag('IDRA 14', 'Tuesday Overall'), tandemFragments: tandemFrags('IDRA 14', '2024 Tuesday', ['Series A', 'Series B', 'Series C']) },
      { fleetId: 'fl-ilca7', name: 'ILCA 7', system: 'scratch', fragment: frag('ILCA 7', 'Tuesday Overall'), tandemFragments: tandemFrags('ILCA 7', '2024 Tuesday', ['Series A', 'Series B', 'Series C']) },
      { fleetId: 'fl-ilca6', name: 'ILCA 6', system: 'scratch', fragment: frag('ILCA 6', 'Tuesday Overall'), tandemFragments: tandemFrags('ILCA 6', '2024 Tuesday', ['Series A', 'Series B', 'Series C']) },
      { fleetId: 'fl-melges15', name: 'Melges 15', system: 'scratch', fragment: frag('Melges 15', 'Tuesday Overall'), tandemFragments: tandemFrags('Melges 15', '2024 Tuesday', ['Series A', 'Series B', 'Series C']) },
      { fleetId: 'fl-pyclass', name: 'PY Class', system: 'py', fragment: frag('PY Class', 'Tuesday Overall'), tandemFragments: tandemFrags('PY Class', '2024 Tuesday', ['Series A', 'Series B', 'Series C']) },
...
// time-on-time coefficient, like VPRS) pools publish under "2024 Summer Series";
...
const TUESDAY_CRUISERS: Group = {
  out: 'dbsc-2024-tuesday-cruisers', name: 'DBSC 2024 — Tuesday Cruisers',
  day: 'Tuesday', echoSuffix: 'Tue',
  subSeriesNames: ['Tuesday Overall', { name: '2024 Summer Series', fleetIds: ['cf-combined', 'cf-cg2'] }],
  classNames: [],
  fleetClassOverride: {
  ...
  build: (opts) => buildFleetSeries(
    [
      { fleetId: 'cf-combined', name: 'Combined Cruisers', system: 'echo', fragment: frag('Combined Cruisers (Tue)', '2024 Summer Series') },
      { fleetId: 'cf-cg2', name: 'Combined Group 2', system: 'vprs', fragment: frag('Combined Group 2 (Tue)', '2024 Summer Series') },
