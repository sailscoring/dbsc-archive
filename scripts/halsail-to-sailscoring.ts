 ...
 * `sources/2026-live/halsail/` (captured per
 ...
 * side of the parity loop in `../sailscoring/docs/design/dbsc-parity-plan.md`.
 *
 * Day-aware: `pnpm to-sailscoring [thursday|saturday|tuesday]`
 ...
 * (re-fetch fragments with `pnpm fetch`).
 */
...
const DATA_DIR = join(__dirname, '..', 'sources', '2026-live');
