 ...
 * `sources/2026-live/README.md`). Runs
 ...
 * points divergence.
 *
 * The parity bar (../sailscoring/docs/design/dbsc-parity-plan.md): same competitors, same
 * per-race points (incl. coded results and the per-race DNC value), same
 * discards, same net scores, same finishing order.
 *
 * Run via `pnpm compare`. Exit code 1 if any fleet diverges.
 */
