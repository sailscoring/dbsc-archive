 ...
 * `sources/2026-live/halsail/` — step 1 of the weekly
 * parity loop (see that dir's README and `../sailscoring/docs/design/dbsc-parity-plan.md`).
 *
 ...
 *
 * Run via `pnpm fetch`. Network + file IO only — no DB.
...
const HALSAIL_DIR = join(__dirname, '..', 'sources', '2026-live', 'halsail');
